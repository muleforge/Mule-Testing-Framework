...
-----------------------------------------------------------------
./src/main/java/org/mule/module/xxx/i18n/XxxMessages.java:

The XxxMessages java class contains methods for access i18n messages embedded in your java code.

-----------------------------------------------------------------
./src/main/resources/META-INF/services/org/mule/i18n/xxx-messages.properties

These message properties contain i18n strings used by XxxMessages.java.
...
-----------------------------------------------------------------
./src/test/java/org/mule/module/xxx/XxxTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/xxx-functional-test-config.xml

Defines the Mule configuration for the XxxTestCase.java.
